...
INSERT INTO Users values('abhishek','abhishek@gmail.com','abhishek123','super_admin');
INSERT INTO Users values('lokesh','lokeshk@gmail.com','lokesh123','super_admin');
INSERT INTO Users values('pavani','pavani@gmail.com','pavani123','super_admin');
...
INSERT INTO Users values('rajeshwari','rajeshwari@gmail.com','rajesjwari123','employee');
INSERT INTO Users values('ammu','ammu@gmail.com','ammu123','admin');

delete from Users where user_email='ckandithapavani@gmail.com';
...
insert into StatusTable(template_id,user_id,topic_id) values(201,124,1);
...
drop table Template;
drop table Users;
select s.user_id,t.template_name from Template as t,StatusTable as s where s.template_id=t.template_id;