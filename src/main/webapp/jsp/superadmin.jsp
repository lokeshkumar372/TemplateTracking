...
<body>
	<div class="superadmin-container">
		...
		<div class="parent-create-options">
			...
			<a  class="button" type="submit" value="Create Admin" href="jsp/createUser.jsp?role=admin">Create Admin</a>
				
			</div>
			<div class="child-create-option-employee">
				<a class="button" type="submit" value="Create Employee" href="jsp/createUser.jsp?role=employee">Create Employee</a>
			</div>
		</div>
			...
			<table class="display-table">
				...
				<tbody>
					...
					<tr>
						<td><%=me.getKey()%></td>
						<td><%=me.getValue()%></td>
						<td><input onclick = "() => {console.log('J')}" type="button" value="Delete"></td>
					</tr>
					<%
					}
					}
