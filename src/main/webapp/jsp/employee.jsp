...
<body>
	<div class="container">
		<div class="welcome-employee">Welcome Employee</div>
						...
						<tr id=<%=t.getTopic_id()%>>
							...
							<td><select name=<%=status_id%>
								onchange="location = this.value;">
									<option
										value=<%="UpdateStatus?template_id=" + template_id + "&status_id=" + status_id + "&status=started"%>
										<%=status.equals("started") ? "selected" : ""%>>On it</option>
									<option
										value=<%="UpdateStatus?template_id=" + template_id + "&status_id=" + status_id + "&status=not_started"%>
										<%=status.equals("not started") ? "selected" : ""%>>Not
										yet started</option>
									<option
										value=<%="UpdateStatus?template_id=" + template_id + "&status_id=" + status_id + "&status=done"%>
										<%=status.equals("done") ? "selected" : ""%>>Completed</option>
							</select></td>
						</tr>
						<%
						}
